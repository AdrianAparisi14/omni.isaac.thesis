...
# to run the program use: ./python.sh ../../../../../Documents/sdu.extensions.2023.1.1/exts/omni.isaac.thesis/omni/isaac/thesis/force_dataset/force_dataset_standalone_pick_place_admittance.py 
...
simulation_context.set_simulation_dt(physics_dt=1/240.0, rendering_dt=1/240.0)
...
class dataset_generation():
    ...
    def init_step(self):
        ...
        self.init_target_random = np.add(init_target,[random.uniform(-0.0001, 0.0001),random.uniform(-0.0001, 0.0001),0.325])
        # self.init_target_random = np.add(init_target,[0.0,0.0,0.325])
        ...
        self.adm_controller.D = np.diag([4000, 4000, 4000]) # [15000, 15000, 15000] [3000, 3000, 3000] 160, 160, 160])
        self.adm_controller.K = np.diag([30, 30, 30])# [20000, 20000, 20000] [20, 20, 20] [54, 54, 54])
    ...
    def get_hole_target(self, pose, orientation, timestep):
        ...
        if hole_target_pose[2] < 0.0355: # 0.0365:
            hole_target_pose[2] = 0.0355
    ...
    def physics_step_prev(self):
        ...
        XFormPrim(prim_path="/World/"+ piece,position=np.add(target_pick_no_offset,[random.uniform(-0.003, 0.003),random.uniform(-0.005, 0.005),0.0]),orientation=r.euler_angles_to_quat(euler_angles=[0,180,random.uniform(-10, 10)],degrees=True))
        rot = None
        rot = r.euler_angles_to_quat([180,0,0],degrees=True)
        ...
        target_pick = np.add(target_pick_no_offset,[0.0,0.0,0.151])
    ...
    def physics_step(self):
        ...
        self.lp_filter.process(self.wrist_forces)
        self.wrist_forces = [self.lp_filter.f_filtered[0],self.lp_filter.f_filtered[1],self.lp_filter.f_filtered[2],self.lp_filter.mu_filtered[0], self.lp_filter.mu_filtered[1],self.lp_filter.mu_filtered[2]]
        ...
        if self.counter < 0.5:
            f_w *= 0.1 # To avoid the influence of the acceleration since in Isaac there is no zeroing
        else:
            f_w[2] -= 0.4 # To compensate the weight of the piece
            
        if f_w[2] < -32.5:
            f_w[2] = -32.5 + 0.05*f_w[2]
...
while simulation_app.is_running():
    try:
        ...
        csv_file_path = "../../../../../Documents/sdu.extensions.2023.1.1/exts/omni.isaac.thesis/omni/isaac/thesis/force_dataset/csv_pick_place/sim/admittance/data" + str(current_time) + ".csv"
        ...
        csv_file_interpolated = "../../../../../Documents/sdu.extensions.2023.1.1/exts/omni.isaac.thesis/omni/isaac/thesis/force_dataset/csv_pick_place/sim/admittance_interpolated/data" + str(current_time) + ".csv"
        ref_timeseries_path = "../../../../../Documents/sdu.extensions.2023.1.1/exts/omni.isaac.thesis/omni/isaac/thesis/force_dataset/csv_pick_place/real/admittance_all_correct/data2024-04-29 13:26:42.095772.csv"
